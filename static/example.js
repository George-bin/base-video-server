...
// const options = {
//   'bosh': 'http://localhost/http-bind?room=testmeet',
//   'hosts': {
//     'domain': 'testmeet.com',
//     'muc': 'conference.testmeet.com'
//   }
// }
...
function onUserLeft (id) {
  ...
  // 用户退出，删除对应的dom元素 start
  $(`body video[id  ^= ${id}]`).remove()
...
function onConnectionSuccess () {
  console.warn('连接成功')
  room = connection.initJitsiConference('bb', confOptions)
  // 收到轨道回调
